...
insert into tb_addres (public_place, zip_code, number, city) values ('Rua A', 100000, 1, 'Mogi das Cruzes');
insert into tb_addres (public_place, zip_code, number, city) values ('Rua B', 110000, 2, 'Itu');
