...
insert into tb_addres (public_place, zip_code, number, city, status) values ('Rua A', 100000, 1, 'city01', 'PRIMARY');
insert into tb_addres (public_place, zip_code, number, city, status) values ('Rua B', 110000, 2, 'city02', 'SECONDARY');
